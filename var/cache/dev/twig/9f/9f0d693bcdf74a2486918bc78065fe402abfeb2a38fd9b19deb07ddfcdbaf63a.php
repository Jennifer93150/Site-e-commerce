...
class __TwigTemplate_83ffbba0d7b6e415fc10ce6a60e13c1c58c36fd3cc393d8cb84e1b2987aa5851 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Koababi | Modification du mot de passe";
...
<div class=\"container\">  
    ...
    <a href=\"";
        ...
        echo "\"><strong> <- Retour à mon compte</strong></a></br>
    ";
        // line 10
    ...
    ";
        ...
        ";
        // line 21
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 21, $this->source); })()), 'form');
        echo "
    </div>
</div>
";
    ...
    {
        return array (  133 => 21,  130 => 20,  121 => 17,  118 => 16,  113 => 15,  104 => 12,  101 => 11,  97 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Koababi | Modification du mot de passe{% endblock %}

{% block body %}

<div class=\"container\">  
    <h1>Modifier mon mot de passe</h1>
    <a href=\"{{path('account')}}\"><strong> <- Retour à mon compte</strong></a></br>
...
{% endblock %}
", "account/password.html.twig", "/Applications/MAMP/htdocs/KOABABI/Koababi/templates/account/password.html.twig");
    }
}
